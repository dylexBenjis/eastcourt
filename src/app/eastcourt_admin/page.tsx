...
<div className='absolute inset-0 max-w-full bg-black bg-opacity-40'></div>
  ...
  <p className="text-md lg:text-lg"><Link  href='/post_property' className="cursor-pointer text-blue-500 hover:text-blue-700 no-underline">Click here</Link> to submit properties or scroll down to start viewing properties close to you.</p>
</div>
</div>

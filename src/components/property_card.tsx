...
import { Approved_property, Property } from "../lib/upload-properties";
      ...
      <div className="relative h-48 w-full">
        {listing.images?.length === 0 ? (
          ...
          <Image
            ...
            alt={listing.images?.[0]?.imageUrl || "/placeholder.svg"}
            fill
            className="object-cover"
          />
        )}
        <Badge className="absolute right-2 top-2 bg-primary px-2 py-1">
